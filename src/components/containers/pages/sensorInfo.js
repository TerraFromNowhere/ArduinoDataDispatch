...
return (
        ...
        <div>
            ...
            <StyledForm>       
                <StyledInput  onKeyPress = {(eve)=>{keyNullifier(eve)}} onChange={(eve)=>{submitValidator(eve,setSeNumber)}} placeholder = "Set sensor id (1-6)" className="inp" type="text" ></StyledInput>
            </StyledForm>
